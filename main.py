...
while True:
    ...
    if len(currentPath) == 0:
        break
    elif (unvisitedNeighborCellCount := len(unvisitedNeighborCells := getUnvisitedNeighborCells(currentPath[-1]))) > 0:
        maze[currentPath[-1]] += "v"
        currentPath.append(unvisitedNeighborCells[random.randrange(unvisitedNeighborCellCount)])
        maze[currentPath[-1]] += "v"
...
print(mazeVisual(True))

print(mazeVisual(False))